...
module.exports = {
	...
	//FO
		...
		command_product_name: '//div[@class="product-line-grid-body col-md-5 col-xs-5"]/div[1]/a',
		command_product_price: '//div[@class="product-line-grid-body col-md-5 col-xs-5"]/div[2]',
