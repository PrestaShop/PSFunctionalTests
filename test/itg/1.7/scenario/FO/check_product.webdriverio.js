...
describe('The Check of the Product in Front Office', function () {
    ...
    describe('Check the product', function (done) {
        ...
        it('should check the product name', function (done) {
            global.fctname = this.test.title;
            this.client
                .waitForExist(this.selector.FO.Search.product_result_name, 90000)
                .getText(this.selector.FO.Search.product_result_name).then(function (text) {
                var my_name = text;
        ...
        it('should check the product price', function (done) {
            global.fctname = this.test.title;
            this.client
                .getText(this.selector.FO.Search.product_result_price).then(function (text) {
                var my_price = text;
