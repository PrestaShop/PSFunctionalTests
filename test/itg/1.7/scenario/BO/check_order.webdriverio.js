...
describe('The Check of the order in Back Office', function () {
    ...
    describe('Check the order', function (done) {
        ...
        it('should check the order reference', function (done) {
            global.fctname = this.test.title;
            this.client
                .getText(this.selector.BO.Order.reference).then(function (text) {
        ...
        it('should check the product name', function (done) {
            global.fctname = this.test.title;
            this.client
                .scroll(this.selector.BO.Order.order_product_name, 20, 0)
                .waitForExist(this.selector.BO.Order.order_product_name, 90000)
                .getText(this.selector.BO.Order.order_product_name).then(function (text) {
        ...
        it('should check the product quantity', function (done) {
            global.fctname = this.test.title;
            this.client
                .waitForExist(this.selector.BO.Order.quantity, 90000)
        ...
        it('should check the order total', function (done) {
            global.fctname = this.test.title;
            this.client
                .waitForExist(this.selector.BO.Order.total, 90000)
