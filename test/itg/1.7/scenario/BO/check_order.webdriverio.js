...
describe('The Check of the order in Back Office', function () {
    ...
    describe('Check the order', function (done) {
        it('should go to the orders page', function (done) {
            global.fctname = this.test.title;
            this.client
                .click(this.selector.BO.Order.orders_subtab)
                .waitForExist(this.selector.BO.Order.form, 90000)
                .call(done);
        });
        ...
        it('should check the order reference', function (done) {
            global.fctname = this.test.title;
            this.client
                .getText(this.selector.BO.Order.order_reference_span).then(function (text) {
        ...
        it('should check the product name', function (done) {
            global.fctname = this.test.title;
            this.client
                .scroll(this.selector.BO.Order.order_product_name_span, 20, 0)
                .waitForExist(this.selector.BO.Order.order_product_name_span, 90000)
                .getText(this.selector.BO.Order.order_product_name_span).then(function (text) {
        ...
        it('should check the product quantity', function (done) {
            global.fctname = this.test.title;
            this.client
                .waitForExist(this.selector.BO.Order.order_product_quantity_span, 90000)
                .getText(this.selector.BO.Order.order_product_quantity_span).then(function (text) {
        ...
        it('should check the order total', function (done) {
            global.fctname = this.test.title;
            this.client
                .waitForExist(this.selector.BO.Order.order_product_total, 90000)
                .getText(this.selector.BO.Order.order_product_total).then(function (text) {
