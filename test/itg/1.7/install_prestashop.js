...
describe('Install PRESTASHOP', function(){
    common.initMocha.call(this);
    runScenario();
});
function runScenario() {
  describe('Step to install :', function(){
	before(function(done){
		this.selector = globals.selector;
		this.client.call(done);
	});
	after(common.after);
    describe('Step 1 : Choose language', function(){
    ...
    describe('Step 2 : License agreements', function(){
        it('Agree License agreements', function(done){
            this.client
	...
	describe('Step 3 : System compatibility', function(){
	...
	describe('Step 4 : Store information', function(){
		it('Should insert shop information', function(done){
			this.client
	 ...
	 describe('Step 5 : System configuration', function(){
		it('Database configuration', function(done){
			this.client
