	...
	after(common.after);
		...
		it('create_customer_account_FO', function(done){
			this.client
				...
				.waitForVisible(this.selector.create_account, 5000)
				.setValue2(this.selector.create_account, new_customer_email)
				.click2(this.selector.create_account_button)
				.waitForVisible(this.selector.create_account_firstname,5000)
				...
				.waitForVisible('.alert.alert-success', 5000)
				.call(done);
		});
		...
		it('log_out_and_login_again', function(done){
			this.client
				...
				.waitForVisible(this.selector.logo_home_pageFO, 5000)
				.call(done);
		});
