...
module.exports = {
	...
	//FO
		...
		command_product_name: '//div[@class="product-line-grid-body col-md-6"]/div[1]/a',
		command_product_price: '//div[@class="product-line-grid-body col-md-6"]/div[2]',
		command_product_quantity: '//div[@class="product-line-grid-body col-md-6"]/div[5]',
